            ...
            <div className="space-y-8 animate-fade-in" id="drugs-directory-index">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-3 space-y-6">
                  {/* Structured index layout with agent corridors */}
                  ...
                  {filteredDrugs.map((d) => {
                    ...
                    return (
                      <Link
                        key={d.id}
                        to={`/drugs/${d.slug}`}
                        className={`bg-white border border-slate-200 border-l-4 ${itemStyles.accentLine} ${itemStyles.hover} rounded-2xl p-5 flex flex-col justify-between transition-all group cursor-pointer shadow-3xs h-full`}
                      >
                        <div className="space-y-3">
