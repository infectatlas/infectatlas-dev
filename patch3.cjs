...
const regex = /const PROSE_LINK_RULES: \{ pattern: RegExp; url: string; label\?: string \}\[\] = \[\s*\/\/ Drugs[\s\S]*?\];/m;
const replacement = `const PROSE_LINK_RULES: { pattern: RegExp; url: string; label?: string }[] = [
  ...
  { pattern: /\\bMycoplasma pneumoniae\\b/g, url: "/organisms/myco-pneumoniae" },
  { pattern: /\\bMycoplasma\\b/g, url: "/organisms/myco-pneumoniae" },
  { pattern: /\\bLegionella pneumophila\\b/g, url: "/organisms/l-pneumophila" },
  { pattern: /\\bLegionella\\b/g, url: "/organisms/l-pneumophila" },
